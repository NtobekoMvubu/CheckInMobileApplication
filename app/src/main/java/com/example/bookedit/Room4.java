...
public class Room4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ppn_value = (TextView) findViewById(R.id.tv_hotel4_price_value);
        nor = (TextView) findViewById(R.id.tv_hotel4_room_no_value);
        ...
        hotelname = (TextView) findViewById(R.id.tv_hotel4_name);
        ...
        iv_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.onomo1);
            }
        });
        ...
        iv_bottomleft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.onomo2);
            }
        });
        iv_bottommid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.onomo3);
            }
        });
        iv_bottomright.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.onomo4);
        ...
        btn_sendemail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    message.setSubject(pref.getString("fname", null).toString() + " " + pref.getString("sname", null).toString() + "'s " + "Enquiry about Onomo Hotel"  );
                    message.setText(messageToSend);
                    Transport.send(message);
                    Toast.makeText(Room4.this, "Enquiry Sent successfully", Toast.LENGTH_LONG).show();
