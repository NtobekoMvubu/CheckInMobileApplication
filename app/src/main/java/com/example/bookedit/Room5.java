...
public class Room5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ppn_value = (TextView) findViewById(R.id.tv_hotel5_price_value);
        nor = (TextView) findViewById(R.id.tv_hotel5_room_no_value);
        ...
        hotelname = (TextView) findViewById(R.id.tv_hotel5_name);
        ...
        iv_bottomleft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.bluewaters3);
            }
        });
        ...
        iv_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.bluewaters2);
            }
        });
        ...
        iv_bottomright.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.bluewaters5);
            }
        });
        ...
        iv_bottommid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.bluewaters4);
            }
        });
        ...
        btn_sendemail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    message.setSubject(pref.getString("fname", null).toString() + " " + pref.getString("sname", null).toString() + "'s " + "Enquiry about Blue Waters Hotel"  );
                    message.setText(messageToSend);
                    Transport.send(message);
                    Toast.makeText(Room5.this, "Enquiry Sent successfully", Toast.LENGTH_LONG).show();
