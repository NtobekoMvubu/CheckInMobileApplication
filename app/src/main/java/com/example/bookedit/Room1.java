...
public class Room1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ppn_value = (TextView) findViewById(R.id.tv_hotel1_price_value);
        nor = (TextView) findViewById(R.id.tv_hotel1_room_no_value);
        ...
        hotelname = (TextView) findViewById(R.id.tv_hotel1_name);
        ...
        editor1.putString("nor", "Number of Rooms: 4");
        editor1.putInt("price", 550);
        editor1.apply();
        ...
        iv_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.musgrave);
            }
        });
        ...
        iv_bottomleft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.musgrave1);
            }
        });
        iv_bottommid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.musgrave2);
            }
        });
        iv_bottomright.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.musgrave4);
        ...
        btn_sendemail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    message.setSubject(pref.getString("fname", null).toString() + " " + pref.getString("sname", null).toString() + "'s " + "Enquiry about Coastlands Musgrave Hotel"  );
                    message.setText(messageToSend);
                    Transport.send(message);
                    Toast.makeText(Room1.this, "Enquiry Sent successfully", Toast.LENGTH_LONG).show();
