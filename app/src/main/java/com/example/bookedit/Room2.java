...
public class Room2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ppn_value = (TextView) findViewById(R.id.tv_hotel2_price_value);
        nor = (TextView) findViewById(R.id.tv_hotel2_room_no_value);
        ...
        hotelname = (TextView) findViewById(R.id.tv_hotel2_name);
        ...
        editor1.putString("nor", "Number of Rooms: 8");
        editor1.putInt("price", 750);
        editor1.apply();
        ...
        iv_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.pearls1);
            }
        });
        ...
        iv_bottomleft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.pearls2);
            }
        });
        iv_bottommid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.pearls3);
            }
        });
        iv_bottomright.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                iv_main.setImageResource(R.drawable.pearls4);
        ...
        btn_sendemail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    message.setSubject(pref.getString("fname", null).toString() + " " + pref.getString("sname", null).toString() + "'s " + "Enquiry about Pearls of Umhlanga"  );
                    message.setText(messageToSend);
                    Transport.send(message);
                    Toast.makeText(Room2.this, "Enquiry Sent successfully", Toast.LENGTH_LONG).show();
